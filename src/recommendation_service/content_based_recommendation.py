"""
Content-based recommendations: query user preference vector from Pinecone user index,
then similarity-search the book index to return top-k book IDs and scores.
"""
import os
